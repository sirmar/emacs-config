...
*** TODO Do stuff in :config instead of :init for use-package     :setting:
*** TODO Smartscan commands should be case sensitive.                 :add:
*** TODO Use and bind Smartscan rename global and in function.    :setting:
