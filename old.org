...
Homepage: [[https://bitbucket.org/jonwaltman/pydoc-info/]]
...
#+BEGIN_SRC emacs-lisp
  (defun config-buffers ()
    ...
    (if (> (display-pixel-width) 1500)
      (progn
        (setq second-window (split-window first-window 200 t)))
      (progn
        (setq second-window (split-window first-window 115 t)))))
...
** Text manipulation
*** Indentation
Setting lisp indentation to two spaces. Others to four.
...
Use jedi source for python mode.
...
Make popup span over buffer limit.
...
#+BEGIN_SRC emacs-lisp
  (use-package fullframe
    ...
    (progn
      ...
      (fullframe find-grep-dired quit-window t)))
#+END_SRC
...
** Instant feedback
*** White space mode
Show trailing spaces and show me tabs used for indentation.
...
Show a vertical line at 120 characters when in programming modes.
...
;;  (set-face-background 'hl-line "#444400")
  (set-face-background 'hl-line "#F9F9DD")
#+END_SRC

*** Highlight indentation
Homepage: [[https://github.com/antonj/Highlight-Indentation-for-Emacs]]

Show indentation levels in general and the current line level in
particular.
    ...
    (progn
      (add-hook 'prog-mode-hook
        (lambda ()
          ...
          (set-face-background 'highlight-indentation-face "#EEEEDD")
          ;; (set-face-background 'highlight-indentation-face "#353520")
      ))
      ...
      (add-hook 'prog-mode-hook
        (lambda ()
          ...
          (set-face-background
            ;; 'highlight-indentation-current-column-face "#151510"
            'highlight-indentation-current-column-face "#CCCCAA")))))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq tramp-default-user "marcus.veiback")
#+END_SRC
** Development cycle
*** Python
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun marcus-bind-run-python-program ()
    (bind-key "C-c r" 'marcus-run-python-program))
...
#+BEGIN_SRC emacs-lisp
  (use-package virtualenvwrapper
    ...
    (progn
      ...
      (setq venv-location "~/code/heroku-proxy/")
      ...
      (add-hook 'venv-postactivate-hook
        (lambda ()
          (setq jedi:environment-root
            (concat venv-location venv-current-name))))))
#+END_SRC

**** Documentation
Homepage: [[https://bitbucket.org/jonwaltman/pydoc-info/]]

Use python docs inside emacs. Needs installation of python
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-todo-keyword-faces
    '(("TODO" . "red") ("DOING" . "Orange") ("DONE" . "green")))
...
** Misc
*** Theme
Load a nice looking dark theme. Make source code blocks have
prettier background colors and fontify code in them according to mode.

#+BEGIN_SRC emacs-lisp
  ;;(use-package monokai-theme
  ;;  :ensure t)
  ;;
  ;;(set-face-background 'region "#226622")
#+END_SRC

Set colors for org mode code blocks.

#+BEGIN_SRC emacs-lisp
 (set-face-background 'org-block-begin-line "#DDDDDD")
;;  (set-face-background 'org-block-background "#EEEEEE")
(set-face-background 'org-block-end-line "#DDDDDD")
(setq org-src-fontify-natively t)
;;  (set-face-background 'org-block-begin-line "#222211")
;;  (set-face-background 'org-block-background "#333322")
;;  (set-face-background 'org-block-end-line "#222211")
;;  (setq org-src-fontify-natively t)
#+END_SRC

Set colors for auto complete popup.

#+BEGIN_SRC emacs-lisp
;;  (set-face-background 'ac-candidate-face "#333322")
;;  (set-face-foreground 'ac-candidate-face "#E6DB74")
;;  (set-face-underline 'ac-candidate-face nil)
;;
;;  (set-face-background 'ac-selection-face "#E6DB74")
;;  (set-face-foreground 'ac-selection-face "black")
;;  (set-face-underline 'ac-selection-face nil)
;;
;;  (set-face-background 'ac-yasnippet-candidate-face "#333322")
;;  (set-face-foreground 'ac-yasnippet-candidate-face "red")
;;  (set-face-underline 'ac-yasnippet-candidate-face nil)
;;
;;  (set-face-background 'ac-yasnippet-selection-face "red")
;;  (set-face-foreground 'ac-yasnippet-selection-face "black")
;;  (set-face-underline 'ac-yasnippet-selection-face nil)
;;
;;  (set-face-background 'popup-face "#333322")
;;  (set-face-foreground 'popup-face "#E6DB74")
;;  (set-face-background 'popup-summary-face "#333322")
;;  (set-face-foreground 'popup-summary-face "white")
#+END_SRC

*** Stack Overflow
Homepage: [[https://github.com/omouse/emacs-sos]]

Search Stack Overflow from within emacs.
...
*** Google
Homepage: [[https://github.com/Bruce-Connor/emacs-google-this]]

Google searches from within emacs.
  ...
  (setq eshell-prompt-function
    (lambda ()
      (concat
        ...
        (propertize (pwd-replace-home (eshell/pwd)) 'face `(:foreground "darkgreen"))
        (propertize "]" 'face `(:foreground "black"))
...
*** DONE Change theme to something nice                           :setting:
CLOSED: [2015-03-07 Sat 18:18]
